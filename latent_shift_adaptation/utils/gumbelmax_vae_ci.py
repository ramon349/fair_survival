...
class GumbelMaxVAECI(gumbelmax_vae.GumbelMaxVAE):
  ...
  def __init__(
    ...
    Args:
      ...
      xu2c_ex_mlp: Boolean variable to indicate if we use multiple layers for our concept classifier model 
      xu2w_ex_mlp: Boolean variable to indicate if we use multiple layers for our proxy classifier model
