...
def build_args():
    ...
    parser.add_argument("--kl_coeff",type=int,required=False)
    parser.add_argument("--vae_epoch",type=int,required=False)
    parser.add_argument("--x2u_epoch",type=int,required=False)
    parser.add_argument("--xu2y_epoch",type=int,required=False)
    parser.add_argument("--calib_epoch",type=int,required=False)
    parser.add_argument("--run_param_search",type=parse_bool,default=False,required=False)
